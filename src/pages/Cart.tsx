...
export function Cart() {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-orange-100 to-yellow-50 p-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-3xl font-bold text-orange-900 mb-4">Pedido Realizado com Sucesso!</h1>
          <p className="text-gray-600 mb-6">
            Obrigado por escolher o Hot Dog Mania. Seu pedido está sendo preparado e logo será entregue.
          </p>
          <Link
            to="/"
  ...
  if (items.length === 0) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-orange-100 to-yellow-50 p-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-2xl font-bold text-orange-900 mb-4">Seu carrinho está vazio</h1>
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-100 to-yellow-50">
      <div className="max-w-4xl mx-auto p-4">
        ...
        <div className="bg-white rounded-xl shadow-md overflow-hidden p-6">
          <h1 className="text-2xl font-bold text-orange-900 mb-6">Seu Carrinho</h1>
          ...
          <div className="text-xl font-bold text-orange-900 mb-6">
